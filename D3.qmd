...
tokenize_annotate = function(tbl){
  ...
  unnest_tokens(word, token, drop = F) %>% 
  cbind_morphological(term = "feats",  
                      which = c("PronType","NumType","Poss",
                                "Reflex", "Foreign","Abbr",
                                "Typo","Gender","Animacy",
                                "NounClass","Case","Number",
                                "Definite","Degree","VerbForm",
                                "Person","Tense","Mood",
                                "Aspect","Voice","Evident",
                                "Polarity","Polite",
                                "Clusivity")) %>% 
...
x <- meme(u2, "Mami, ati!", "Meljem podatkovni pesek.", 
          size = 2, color = "#D874E1", font='bubble1')
meme_save(x, file="pictures/success5.png")
x
```
...
- V RStudiu v nanovo ustvarjenem dokumentu odprite dve besedili približno enake dolžine!  

- Ugotovite programsko, kolikšen je delež posameznih besednih vrst v vsakem besedilu!

- Ugotovite programsko, kateri samostalniki se najpogosteje pojavljajo v vsakem besedilu!  

- Narišite stolpčni diagram, ki prikazuje po 15 najpogostejših samostalnikov v vsakem besedilu !   
...
- Izberite iz obeh izbranih besedil po eno poved!

- Narišite diagram, ki prikazuje dependenčne odnose med stavčnimi prvinami!
...
- Ugotovite v obeh besedilih deleže dveh besednih vrst, samostalnikov in zaimkov, v vlogi stavčnega osebka ali premega predmeta in jih strnite v obliki tabele!

- Narišite še diagram, ki prikazuje morebitne razlike med deleži samostalnikov in zaimkov v obeh besedilih!
...
x <- meme(u2, "Mami, Ati!", "Noben pesek mi ni ušel!", 
          size = 3, color = "#D874E1", font='sans')
meme_save(x, file="pictures/success6.png")
x
```
