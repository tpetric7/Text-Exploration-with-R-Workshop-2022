...
Velika razlika med *mediano* (24,00) in *povprečjem* (59,45) kaže, da vrednosti pogostnosti besed niso normalno porazdeljene. To je za jezikovna gradiva povsem običajno.
...
animate(anim_pages, duration = 5, fps = 20, width = 480, height = 640, renderer = gifski_renderer())
...
x <- meme(u2, "Mami, ati!", "Gremo na pesek!", 
          size = 2, color = "#D874E1", font='bubble1')
meme_save(x, file="pictures/success7.png")
x
```
...
-  V RStudiu odprite dve krajši besedili!  

- Razcepite vsako besedilo v povedi!  

- Odprite primeren sentimentni slovar za slovenščino!  

- Programsko izračunajte čustveno polariteto povedi v vsakem besedilu in ugotovite morebitno razliko med njima!  
...
- Sestavite spletno stran, ki prikazuje eno izmed izbranih besedil in barvno označeno čustveno polariteto besed!   
...
- Programsko izračunajte moč in statistično značilnost dvočlenksih besednih kolokacij v enem izmed izbranih besedil! 

- Pokažite najznačilnejše dvočlenske kolokacije tabelarno!
...
x <- meme(u2, "Mami, Ati!", "Peska je še dost'.", 
          size = 3, color = "#D874E1", font='sans')
meme_save(x, file="pictures/success8.png")
x
```
